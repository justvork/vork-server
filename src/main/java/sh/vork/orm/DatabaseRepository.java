...
/**
 * Generic repository contract for ORM-managed entities.
 *
...
public interface DatabaseRepository<T extends DatabaseEntity> {
     ...
     *
     * <p>The stream <strong>must</strong> be closed after consumption. Use try-with-resources.
     *
     * @param page      zero-based page index
     * @param pageSize  maximum number of entities to return
     ...
     * Only {@link sh.vork.orm.mongo.MongoDBRepository} supports this method.
     *
     * @param page         zero-based page index
     * @param pageSize     maximum number of entities to return
